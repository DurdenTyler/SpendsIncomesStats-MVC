...
extension IncomesView {
    private func setConstraints() {
        NSLayoutConstraint.activate([
            incomesTitle.centerXAnchor.constraint(equalTo: self.centerXAnchor, constant: 0),
            incomesTitle.topAnchor.constraint(equalTo: self.safeAreaLayoutGuide.topAnchor, constant: 5)
        ])
